...
<meta http-equiv="refresh" content="5; URL='https://www.yourcoach.ie/' " />

<main>
  <br><br>
  <section class="section pt-3 pb-4">
    <h1 class="text-center text-uppercase font-weight-bold  mt-5 mb-3 mt-4 wow fadeIn" data-wow-delay="0.2s">MESSAGE SENT</h1>    
    <p class="text-center green-text text-uppercase font-weight-bold  wow fadeIn" data-wow-delay="0.2s">Thank you for your message. We will get back to you shortly.</p>
    <div class="line wow fadeIn container" data-wow-delay="0.2s"><hr></div>
    <br><br>
    <div class="container" align="center">
    <img src="./static/img/logos/logo1.png" class="img-fluid" width="20%">
    <br><h2>YOUR COACH</h2>
